...
export default function map() {
  ...
  function addNewIms(){
    ...
    for (const [volcanName, volcan] of Object.entries(_volcanes)) {
      ...
      var imageUrl = `/img/heatmap_${bins}_Reds_r/${volcanName}.png`
      if(['Huanquihue Group', 'Carrán-Los Venados', 'Yanteles', 'Viedma'].indexOf(volcanName) >= 0)  imageUrl = `/img/heatmap_2_Reds_r/Mocho-Choshuenco.png`
      if(['Puntiagudo', 'Tronador', 'Arenales', 'Aguilera', 'Reclus', 'Fueguino', 'Monte Burney'].indexOf(volcanName) >= 0)  imageUrl = `/img/heatmap_2_Reds_r/Mocho-Choshuenco.png`
