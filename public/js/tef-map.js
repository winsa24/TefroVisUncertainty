...
export default function map() {
  ...
  map.addVolcanoes = function (volcanes) {
    ...
    .domain([0,500])// TODO:: normlize volcan sample number
    ...
    volcanes.forEach(function (volcan, i) {
      ...
      let sampleNumbers = (volcan.bulk_pyroclastic_regression_SampleNumber!=-1?volcan.bulk_pyroclastic_regression_SampleNumber:0 )+ (volcan.effusive_regression_SampleNumber!=-1?volcan.effusive_regression_SampleNumber:0 )
